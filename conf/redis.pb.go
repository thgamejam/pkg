...
type Redis struct {
	...
	DelayDeleteTime *duration.Duration `protobuf:"bytes,6,opt,name=delay_delete_time,json=delayDeleteTime,proto3" json:"delay_delete_time,omitempty"`
}
...
var file_redis_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x72, 0x65, 0x64, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x74,
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_redis_proto_goTypes = []interface{}{
	(*Redis)(nil),             // 0: thjam.pkg.conf.Redis
	(*duration.Duration)(nil), // 1: google.protobuf.Duration
}
var file_redis_proto_depIdxs = []int32{
	1, // 0: thjam.pkg.conf.Redis.read_timeout:type_name -> google.protobuf.Duration
	1, // 1: thjam.pkg.conf.Redis.write_timeout:type_name -> google.protobuf.Duration
	1, // 2: thjam.pkg.conf.Redis.delay_delete_time:type_name -> google.protobuf.Duration
